...
MoInVis.Paracoords.contextIndicator = function (
    parent,
    x,
    y,
    height,
        ...
        _init = function () {
            ...
            _conTEXTEl.attr(
                ...
                'translate(' +
                    (_arrowX - _arrowGap) +
                    ',' +
                    (_arrowY + _arrowSize / 2 + 0.35 * textBBox.height) +
                    ')'
            );
        ...
        if ((this.visible = visibility)) {
            ...
            if (_isTop) {
                _ciSVG
                    ...
                    .attr(
                        'transform',
                        'translate(' + _xPos + ',' + (_yPos - 2 * _height) + ')'
                    )
                    .on('end', _hide);
            } else {
                _ciSVG
