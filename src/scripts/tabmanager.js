...
MoInVis.Paracoords.tabManager = function (moin, tabHandlers, startTabIndex) {
    ...
    var self = this,
        ...
        _setTabStyle = function (tab) {
            tab.style('height', _moin.height + 'px')
                .style('width', _moin.width + 'px')
                .style('position', 'fixed');
        },
        _init = function () {
            var i,
                length = _tabHandlers.length,
                tab;
            ...
            _tabIndicatorDiv = d3
                ...
                .style(
                    'left',
                    _moin.width / 2 - length * _tabIndicatorSize + 'px'
                )
                .style('top', '3%')
                .style('opacity', 0);
            _tabIndicatorDiv
    ...
    this.swipeLeft = function () {
        ...
        _tabIndicators[_currentTabIndex].style(
            'opacity',
            _inactiveTabIndicatorOpacity
        );
