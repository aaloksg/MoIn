    ...
    var self = this,
        ...
        _sortDataSet = function () {
            if (_emphasisedFirst) {
                _barChartData.sort(
                    (a, b) =>
                        d3.ascending(a.emphasised, b.emphasised) ||
        ...
        _showBarLabels = function () {
            if (_nameShown) {
                d3.select('#axisDetailView_BarLabel_Name').attr(
                    'display',
                    'block'
                );
                d3.select('#axisDetailView_BarLabel_Value').attr(
                    'display',
                    'none'
                );
            } else {
        ...
        _updateBarChart = function () {
            ...
            const width =
                _getWidthOfElementById('axisDetailView') - scrollbarWidth;
            ...
            const x = d3
                .scaleLinear()
                .domain([
                    Math.max(min_value - min_value * 3, 0),
            ...
            document.getElementById('attributeName').innerText =
                _attributeLabel;
            document.getElementById('attributeUnit').innerText =
                '(in ' + MoInVis.Paracoords.Unit + ')';
            ...
            document.getElementById('axisDetailView').style.height =
                document
                    .getElementById('axisDetailViewOverlay')
                    .getBoundingClientRect().height -
                document
                    .getElementById('axisDetailViewHeader')
                    .getBoundingClientRect().height +
                'px';
